...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'satorujogoo00@gmail.com',
            'smtp_pass' => 'kirito234',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
        ...
        $this->email->from('satorujogoo00@gmail.com', 'AKtivasi Akun Anda !');
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('Klik link ini untuk reset password akun anda : <a href="'
