                            ...
                            <ul class="footer-contacts d-inline-block d-sm-block">
                                <li>
                                    <div class="unit">
                                        ...
                                        <div class="unit-body"><a class="link-phone" href="tel:+62 81281117900">+62 81281117900</a></div>
                                    </div>
                                </li>
                                <li>
                                    <div class="unit">
                                        <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                                        <div class="unit-body"><a class="link-aemail" href="mailto:info@itkontama.travel.id" target="_blank" rel="noopener noreferrer">info@itkontama.travel.id</a></div>
                                    </div>
                                </li>
                                <li>
                                    <div class=" unit">
                                        <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                                        <div class="unit-body"><a class="link-location" href="#">Jl. Beringin Raya Blok 35 No.140 Perumnas 1, Nusa Jaya, Karawaci, Kota Tangerang, Banten 15116</a></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="oh-desktop">
                        <div class="wow slideInLeft" data-wow-delay="0s">
                            ...
                            <ul class="row-6 list-0 list-marked list-marked-md list-marked-secondary list-custom-2">
                                <li><a href="<?= base_url('user/about.php'); ?>">About us</a></li>
        ...
        <div class="container">
            <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
                ...
                <div class="col-sm-6 col-md-4 order-sm-first">
                    <!-- Rights-->
                    <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>Itkontama Travel</span>. All Rights Reserved</a></p>
                </div>
...
<!-- Javascript-->
<script src="<?= base_url('assets2/'); ?>js/core.min.js"></script>
